        ...
        <nav className="p-4 space-y-2">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="font-medium flex-1 text-left">Discount&Voucher</span>
              ...
              <div className="mt-2 ml-4 space-y-1">
                {['discounts','vouchers'].map(type => (
                  <button key={type} onClick={() => { navigate(`/discounts?type=${type}`); setShowDiscountDropdown(false); }}
                    ...
                    {type === 'discounts' ? 'Discount' : 'Voucher'}
                  </button>
                ))}
              </div>
            )}
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition ${
              location.pathname === '/users' ? "bg-blue-600 text-white" : "text-gray-700 hover:bg-gray-100"
            }`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
