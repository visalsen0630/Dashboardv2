...
export default function Discounts() {
  ...
  const handleSaveDiscount = async () => {
    try {
      const data = { ...discountForm, company_id: selectedCompanyId, location_id: selectedLocationId };
      if (editingItem) {
  ...
  const handleSaveVoucher = async () => {
    try {
      const data = { ...voucherForm, company_id: selectedCompanyId, location_id: selectedLocationId };
      if (editingItem) {
